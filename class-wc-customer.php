...
class WC_Customer {
	...
	public function get_shipping_subdistrict() {
		return $this->shipping_subdistrict;
	}
	...
	public function set_shipping_subdistrict( $address ) {
		$this->shipping_subdistrict = $address;
	}
