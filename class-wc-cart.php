...
class WC_Cart {
	...
	/*-----------------------------------------------------------------------------------*/
		...
		public function get_shipping_packages() {
			...
			$packages[0]['destination']['subdistrict'] = WC()->customer->get_shipping_subdistrict();
			//$packages[0]['destination']['subdistrict'] = $kkcustomer->get_shipping_subdistrict();
